...
public class GetProfile {
    ...
    public void onSuccess()
    {
        ...
        try {
            ...
            profileFragment._shopname.setText(profile.getJSONObject("profile").getString("shopname"));
            profileFragment._address.setText(profile.getJSONObject("profile").getString("address"));
            profileFragment._tanvat.setText(profile.getJSONObject("profile").getString("tanvat"));
            profileFragment._regno.setText(profile.getJSONObject("profile").getString("registerno"));
            profileFragment._shopestablishment.setText(profile.getJSONObject("profile").getString("shopestablishment"));
            profileFragment._tradelicense.setText(profile.getJSONObject("profile").getString("tradelicense"));
            profileFragment._manufacturinglicense.setText(profile.getJSONObject("profile").getString("manufacturinglicense"));
