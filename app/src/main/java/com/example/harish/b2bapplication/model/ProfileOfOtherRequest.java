...
public class ProfileOfOtherRequest implements Serializable {
    private String email,mobile, thumbnailUrl,billingaddress,nameoffrim,estyear,roll;
    private String userid,connectionstatus;


    public ProfileOfOtherRequest() {
    }

    public ProfileOfOtherRequest(String connectionstatus, String userid, String email, String mobile, String roll, String thumbnailUrl, String billingaddress, String nameoffrim, String estyear){
        this.email=email;
